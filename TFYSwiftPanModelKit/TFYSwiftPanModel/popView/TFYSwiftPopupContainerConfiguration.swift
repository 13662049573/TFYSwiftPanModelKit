...
public extension TFYSwiftPopupContainerConfiguration {
    @discardableResult func width(_ value: TFYSwiftPopupContainerDimension) -> Self {
        width = value
        return self
    }

    @discardableResult func height(_ value: TFYSwiftPopupContainerDimension) -> Self {
        height = value
        return self
    }
    ...
    @discardableResult func contentInsets(_ value: UIEdgeInsets) -> Self {
        contentInsets = value
        return self
    }

    @discardableResult func screenInsets(_ value: UIEdgeInsets) -> Self {
        screenInsets = value
        return self
    }
    ...
    @discardableResult func shadowEnabled(_ value: Bool) -> Self {
        shadowEnabled = value
        return self
    }
    ...
    @discardableResult func shadowOpacity(_ value: Float) -> Self {
        shadowOpacity = value
        return self
    }
